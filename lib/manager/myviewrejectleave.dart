...
class MyViewRejectLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewRejectLeaveManagerState createState() =>
      _MyViewRejectLeaveManagerState();
}

class _MyViewRejectLeaveManagerState extends State<MyViewRejectLeaveManager> {
  @override
  initState() {
    super.initState();
  }
