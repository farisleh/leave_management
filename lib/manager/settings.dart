...
class SettingsPageManager extends StatefulWidget {
  final User user;

  SettingsPageManager({this.user});
  @override
  _SettingsPageManagerState createState() => _SettingsPageManagerState();
}

class _SettingsPageManagerState extends State<SettingsPageManager> {
