...
class MyLeaveManager extends StatefulWidget {
  final User user;
  const MyLeaveManager({Key key, this.user}) : super(key: key);
  @override
  _MyLeaveManagerState createState() => new _MyLeaveManagerState();
}

class _MyLeaveManagerState extends State<MyLeaveManager> {
  ...
  String _enddateText = '';
  bool visible = false;
  String pathAsset = 'assets/images/no-image.png';
  ...
  void _sendData() async {
    ...
    pr.show();
    await http.post(
        "https://attendance.inspirazs.com/php/upload_managerleave.php",
        body: {
      ...
      if (res.body.contains("success")) {
        ...
        Navigator.pop(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => MyLeaveDashboardManager()));
      } else {
        pr.hide();
