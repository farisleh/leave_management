...
class ViewRejectLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewRejectLeaveManagerState createState() => _ViewRejectLeaveManagerState();
}

class _ViewRejectLeaveManagerState extends State<ViewRejectLeaveManager> {
  @override
  initState() {
    super.initState();
  }
