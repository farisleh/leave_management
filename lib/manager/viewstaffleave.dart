...
class ViewStaffLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewStaffLeaveManagerState createState() => _ViewStaffLeaveManagerState();
}

class _ViewStaffLeaveManagerState extends State<ViewStaffLeaveManager> {
  @override
  initState() {
    super.initState();
  }
  ...
  void updateAccept() async {
    ...
    pr.show();
    await http.post(
        "https://attendance.inspirazs.com/php/manager_leave_accept.php",
