...
class ViewAcceptLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewAcceptLeaveManagerState createState() => _ViewAcceptLeaveManagerState();
}

class _ViewAcceptLeaveManagerState extends State<ViewAcceptLeaveManager> {
  @override
  initState() {
    super.initState();
  }
