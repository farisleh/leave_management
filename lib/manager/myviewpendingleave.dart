...
class MyViewPendingLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewPendingLeaveManagerState createState() =>
      _MyViewPendingLeaveManagerState();
}

class _MyViewPendingLeaveManagerState extends State<MyViewPendingLeaveManager> {
  File _image;
  @override
  initState() {
    super.initState();
