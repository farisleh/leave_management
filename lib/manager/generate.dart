...
class GeneratePageManager extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GeneratePageManagerState();
}

class GeneratePageManagerState extends State<GeneratePageManager> {
