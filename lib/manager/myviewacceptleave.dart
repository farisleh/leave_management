...
class MyViewAcceptLeaveManager extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewAcceptLeaveManagerState createState() =>
      _MyViewAcceptLeaveManagerState();
}

class _MyViewAcceptLeaveManagerState extends State<MyViewAcceptLeaveManager> {
  @override
  initState() {
    super.initState();
  }
