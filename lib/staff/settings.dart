...
class SettingsPageStaff extends StatefulWidget {
  final User user;

  SettingsPageStaff({this.user});
  @override
  _SettingsPageStaffState createState() => _SettingsPageStaffState();
}

class _SettingsPageStaffState extends State<SettingsPageStaff> {
