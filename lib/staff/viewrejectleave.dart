...
class ViewRejectLeaveStaff extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewRejectLeaveStaffState createState() => _ViewRejectLeaveStaffState();
}

class _ViewRejectLeaveStaffState extends State<ViewRejectLeaveStaff> {
  @override
  initState() {
    super.initState();
  }
