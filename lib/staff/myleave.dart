...
class MyLeaveStaff extends StatefulWidget {
  final User user;
  const MyLeaveStaff({Key key, this.user}) : super(key: key);
  @override
  _MyLeaveStaffState createState() => new _MyLeaveStaffState();
}

class _MyLeaveStaffState extends State<MyLeaveStaff> {
  ...
  void _sendData() async {
    ...
    pr.show();
    await http.post(
        "https://attendance.inspirazs.com/php/upload_staffleave.php",
        body: {
      ...
      if (res.body.contains("success")) {
        ...
        Navigator.pop(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => DashboardStaff()));
      } else {
        pr.hide();
