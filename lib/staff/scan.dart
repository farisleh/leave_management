...
class ScanStaff extends StatefulWidget {
  final User user;

  const ScanStaff({Key key, this.user}) : super(key: key);
  @override
  _ScanStaffState createState() => new _ScanStaffState();
}

class _ScanStaffState extends State<ScanStaff> {
