...
class ViewAcceptLeaveStaff extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewAcceptLeaveStaffState createState() => _ViewAcceptLeaveStaffState();
}

class _ViewAcceptLeaveStaffState extends State<ViewAcceptLeaveStaff> {
  @override
  initState() {
    super.initState();
  }
