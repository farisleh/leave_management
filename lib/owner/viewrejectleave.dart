...
class ViewRejectLeaveOwner extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewRejectLeaveOwnerState createState() => _ViewRejectLeaveOwnerState();
}

class _ViewRejectLeaveOwnerState extends State<ViewRejectLeaveOwner> {
  @override
  initState() {
    super.initState();
  }
