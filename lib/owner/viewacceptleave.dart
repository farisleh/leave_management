...
class ViewAcceptLeaveOwner extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewAcceptLeaveOwnerState createState() => _ViewAcceptLeaveOwnerState();
}

class _ViewAcceptLeaveOwnerState extends State<ViewAcceptLeaveOwner> {
  @override
  initState() {
    super.initState();
  }
