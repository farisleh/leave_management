...
class SettingsPageOwner extends StatefulWidget {
  final User user;

  SettingsPageOwner({this.user});
  @override
  _SettingsPageOwnerState createState() => _SettingsPageOwnerState();
}

class _SettingsPageOwnerState extends State<SettingsPageOwner> {
