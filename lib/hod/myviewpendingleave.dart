...
class MyViewPendingLeaveHod extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewPendingLeaveHodState createState() => _MyViewPendingLeaveHodState();
}

class _MyViewPendingLeaveHodState extends State<MyViewPendingLeaveHod> {
  File _image;
  @override
  initState() {
    super.initState();
