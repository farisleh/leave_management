...
class MyViewRejectLeaveHod extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewRejectLeaveHodState createState() => _MyViewRejectLeaveHodState();
}

class _MyViewRejectLeaveHodState extends State<MyViewRejectLeaveHod> {
  @override
  initState() {
    super.initState();
  }
