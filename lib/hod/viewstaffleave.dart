...
class ViewStaffLeaveHod extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewStaffLeaveHodState createState() => _ViewStaffLeaveHodState();
}

class _ViewStaffLeaveHodState extends State<ViewStaffLeaveHod> {
  @override
  initState() {
    super.initState();
  }
  ...
  void updateAccept() async {
    ...
    pr.show();
    await http.post("https://attendance.inspirazs.com/php/hod_leave_accept.php",
        body: {'id': widget.id, 'name': widget.name}).then((res) async {
      ...
      if (res.body.contains("success")) {
        ...
        Navigator.pop(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => StaffLeaveDashboardHod()));
