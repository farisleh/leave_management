...
class MyViewAcceptLeaveHod extends StatefulWidget {
  final String id;
  ...
  @override
  _MyViewAcceptLeaveHodState createState() => _MyViewAcceptLeaveHodState();
}

class _MyViewAcceptLeaveHodState extends State<MyViewAcceptLeaveHod> {
  @override
  initState() {
    super.initState();
  }
