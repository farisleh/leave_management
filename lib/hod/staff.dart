...
import 'package:leave_management/hod/viewstaffprofile.dart';

class StaffHod extends StatefulWidget {
  final String email;
  StaffHod({this.email});

  @override
  _StaffHodState createState() => _StaffHodState();
}

class _StaffHodState extends State<StaffHod> {
  List data = [];
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ViewStaffProfileHod(
