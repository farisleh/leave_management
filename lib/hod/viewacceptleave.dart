...
class ViewAcceptLeaveHod extends StatefulWidget {
  final String id;
  ...
  @override
  _ViewAcceptLeaveHodState createState() => _ViewAcceptLeaveHodState();
}

class _ViewAcceptLeaveHodState extends State<ViewAcceptLeaveHod> {
  @override
  initState() {
    super.initState();
  }
